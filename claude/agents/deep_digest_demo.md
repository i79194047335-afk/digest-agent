...
## Lineage
- Input: ../workspace/claude/fail_retry_demo/research_plan.md
- Calls: researcher.md × N → writer.md → evaluator_strict.md → (writer.md retry if FAIL)
- Output: ../workspace/claude/fail_retry_demo/digest_final.md

## Steps
1. Write research plan to ../workspace/claude/fail_retry_demo/research_plan.md
2. For EACH angle, run agents/researcher.md
   Save outputs to ../workspace/claude/fail_retry_demo/research_1.md, research_2.md, research_3.md
3. Run agents/writer.md — but write output to ../workspace/claude/fail_retry_demo/digest_final.md

...
## Lineage
- Input: ../workspace/deepseek/fail_retry_demo/digest_final.md
- Output: ../workspace/deepseek/fail_retry_demo/eval_result.md
...
## Steps
1. Read ../workspace/deepseek/fail_retry_demo/research_plan.md
2. Read ../workspace/deepseek/fail_retry_demo/digest_final.md
3. Check each criterion above with an exact word count
4. If ALL pass → write to ../workspace/deepseek/fail_retry_demo/eval_result.md:
   > PASS
5. If ANY fail → write to ../workspace/deepseek/fail_retry_demo/eval_result.md:
   > FAIL
   > Issues:

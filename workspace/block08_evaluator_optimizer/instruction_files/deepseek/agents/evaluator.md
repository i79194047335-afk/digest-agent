...
## Lineage
- Input: ../workspace/deepseek/digest_final.md
- Output: ../workspace/deepseek/eval_result.md
...
## Steps
1. Read ../workspace/deepseek/research_plan.md to know expected angle count
2. Read ../workspace/deepseek/digest_final.md
3. Check each criterion above
4. If ALL pass → write to ../workspace/deepseek/eval_result.md:
   > PASS
5. If ANY fail → write to ../workspace/deepseek/eval_result.md:
   > FAIL
   > Issues:

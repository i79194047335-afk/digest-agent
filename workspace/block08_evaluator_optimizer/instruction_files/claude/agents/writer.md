...
## Lineage
- Input: ../workspace/claude/research_plan.md + all research_[N].md files
  (+ ../workspace/claude/eval_result.md if this is a retry)
- Output: ../workspace/claude/digest_final.md

## Steps
1. Read ../workspace/claude/research_plan.md
2. Read all files matching ../workspace/claude/research_[N].md
3. If ../workspace/claude/eval_result.md exists and says FAIL:
